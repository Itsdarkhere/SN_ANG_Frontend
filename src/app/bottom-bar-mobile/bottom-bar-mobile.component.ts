  ...
  ngOnInit() {
    ...
    document.onscroll = () => {
      ...
      if (st > this.lastScrollTop) {
        // scroll down
        if (
          document.querySelector(".global__bottom-bar-mobile") &&
          document.querySelector(".global__bottom-bar-mobile").classList.contains("scrolled")
        ) {
      ...
      handle = setTimeout(() => {
        // callback when user stops scroll
