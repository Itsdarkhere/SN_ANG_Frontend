...
@Component({
  selector: "app-eth-marketplace-left-bar-mobile",
  templateUrl: "./eth-marketplace-left-bar-mobile.component.html",
  styleUrls: ["./eth-marketplace-left-bar-mobile.component.scss"],
  animations: [
...
export class EthMarketplaceLeftBarMobileComponent {
